...
function addProject() {
  ...
  let parsedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.parse)(formDate, "dd-MM-yyyy", new Date());
  ...
  if (parsedDate && !isNaN(parsedDate)) {
    cardDiv.dataset.date = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.format)(parsedDate, "yyyy-MM-dd");
    const sortedCards = Array.from(content.children).sort((a, b) => {
      return (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.compareAsc)(
        (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.parse)(a.dataset.date, "yyyy-MM-dd", new Date()),
        (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.parse)(b.dataset.date, "yyyy-MM-dd", new Date())
      );
    });
  ...
  let selectCard = document.querySelectorAll("#card").forEach((card) => {
    card.addEventListener("click", _edit_card__WEBPACK_IMPORTED_MODULE_0__.editCard);
  });
}
